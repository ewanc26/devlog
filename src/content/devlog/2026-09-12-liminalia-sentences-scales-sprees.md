...
description: Per-crime sentences replace the flat fine, affinity and education move onto the central 0-100 scale with save migration, and opportunity criminals can go on sprees.
...
`5c8946d` — the justice system gets a sentencing table, every stat lands on one scale, and desperate criminals strike more than once.
...
Theft, burglary and vandalism retain half their pressure after committing. A desperate burglar with opportunity still in front of them strikes again — a spree, instead of cooling to zero after one crime. Arson and murder discharge fully: one fire, one body.
