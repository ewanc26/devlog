<!-- Minimal site footer: publication credit and GitHub link -->
<footer class="border-t border-[var(--color-border)] px-6 py-4 text-center text-[0.75em] text-[var(--color-dim)]">
	...
	·
	<a href="https://ko-fi.com/ewancroft" target="_blank" rel="noopener" class="text-[var(--color-muted)] hover:text-[var(--color-accent)] transition-colors no-underline">ko-fi</a>
	·
	<a href="https://github.com/sponsors/ewanc26" target="_blank" rel="noopener" class="text-[var(--color-muted)] hover:text-[var(--color-accent)] transition-colors no-underline">github sponsors</a>
</footer>
